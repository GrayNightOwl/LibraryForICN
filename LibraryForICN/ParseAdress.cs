...
namespace LibraryForICN
{
    ...
    //            return faultResult;
    //        }
    //    } //больше не нужен, вернётся объект, функционал учтён в конструкторе
    ...
    //    public string ParseIndex(string s)
    //    {
    //        try
    //        {
    ...
    //    public string ParseRegion(string s)
    //    {
    //        try
    //        {
    //            string region = "";                                                             //разделено на 2 части:
    ...
    //    public string ParseArea(string s) //код аналогичен распознаванию региона, признак кр/о (край/область) заменён на "р" от "район"
    //    {
    //        try
    //        {
    //            string area = "";
    ...
    //    public string ParseCity(string s)
    //    {
    //        try
    //        {
    //            string city = "";
    ...
    //    public string ParseStreet(string s)
    //    {
    //        try
    //        {
    //            string street = "";
    ...
    //    public string ParseFlat(string s)
    //    {
    //        try
    //        {
    //            string flat = "";
