    ...
    public class AdressTests
    {
        ...
        */
        ...
        public void Street_inputString13_resultString() //наиболее сложный адрес 
        {
            ...
            string s = " 614825 , Еврейская Автономная область, Биробиджанский район, город Биробиджан , улица Степана Разина вторая , дом 115/1, квартира 12 ";
            string expected = "614825, Еврейская Автономная область, Биробиджанский район, г. Биробиджан, ул. Степана Разина вторая, д. 115/1, кв. 12";
            //получаем значения
            Adress adress = new Adress();
            AdressForCompile res = adress.ParseAdress(s);
            string actual = adress.CompileAdress(res);
